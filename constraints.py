...
class Constraints:
    ...
    def __init__(self, lambda_weight=0, mu_weight=0, kappa_weight=0, nu_weight=0):
        ...
        self.mu_matrix = np.ones(2040-2024)
        ...
        self.kappa_matrix = np.ones(2040-2024)
        ...
        self.nu_matrix = np.ones(2040-2024)
        self.ks_objective = np.concatenate([np.linspace(tech_parameters.ks0, 215600, 2030-2024+1)[:-1], np.linspace(215600, 400600, 2040-2030+1)])
