...
# Load data
load_data = pd.read_csv(simu_parameters.path_inputs + r"/load_scenarios.csv", index_col=0)
residual_load_data = pd.read_csv(simu_parameters.path_inputs + r"/excess_demand.csv", index_col=0)

d_load = np.array(load_data[['2015', '2016', '2017', '2018', '2019', 'favorable', 'adverse']].T, dtype=object)
residual_load = np.array(residual_load_data[['2015', '2016', '2017', '2018', '2019', 'favorable', 'adverse']].T, dtype=object)
...
print("Realistic: ", d_load_mean.mean())
print("deterministic: ", d_load_mean_deterministic.mean())
